...
$user = "root";
$password = "";
$database = "carrental"; // Replace with your database name
...
<body>
    ...
    <div class="container">
        ...
        <!-- Form Section with a Frame and Green Input Fields -->
    ...
    <script>
        // Open the modal and populate it with client data
        ...
        // Function to delete a client by client ID
