...
// Check if car ID is present in the URL
if (!isset($_GET['id'])) {
    echo "<script>alert('Please select a car to book first.'); window.location.href='cars.php';</script>";
    exit();
}
...
<head>
    ...
    <script>
        function updateFare() {
            var acPrice = "Rs. 23/km and Rs. 45/day"; // With AC fare
            var nonAcPrice = "Rs. 23/km and Rs. 21/day"; // Without AC fare
            ...
            if (acRadio.checked) {
                ...
                fareDisplay.innerHTML = "Select a car type"; // Default message
            }
        }
    </script>
</head>
...
<div class="container">
    <div class="form-area">
        <form role="form" action="bookingconfirm.php" method="POST">
            ...
            <input id="ac-radio" onclick="updateFare()" type="radio" name="radio" value="ac"> <b>With AC </b>&nbsp;
