...
<body>
    <div class="container">
        ...
        <form action="complete_order.php?id=<?php echo $orderId; ?>" method="POST">
            ...
            <input type="hidden" name="car_id" value="<?php echo $order['car_id']; ?>"> <!-- Assuming car_id is stored in the order -->
