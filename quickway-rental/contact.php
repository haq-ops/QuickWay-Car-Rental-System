            ...
            while ($row = $feedback_result->fetch_assoc()) {
                ...
                if ($logged_username == $row['username']) {
                    ...
                    echo "<form action='delete_feedback.php' method='POST' style='display:inline;'>
                            <input type='hidden' name='feedback_id' value='{$row['id']}'>
                            <input type='submit' name='delete_feedback' value='Delete' style='background-color: #f44336; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer;' 
