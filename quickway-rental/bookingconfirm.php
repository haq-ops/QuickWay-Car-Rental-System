...
if($err_date >= 0) { 
    ...
    // Check if the car_availability column exists before updating
    ...
    if ($checkColumnResult && mysqli_num_rows($checkColumnResult) > 0) {
        ...
        // Add car_availability column if it does not exist
        ...
        // Now update the car availability
        $sql2 = "UPDATE cars SET available = 'no' WHERE car_id = '$car_id'";
        if (!$conn->query($sql2)) {
...
<div class="container">
    <div class="invoice">
        ...
        <div class="details">
            ...
            <p><strong>Name:</strong> <?php echo $customer_username; ?></p>
        </div>

        <div class="car-details">
            <h3>Vehicle Details</h3>
            <p><strong>Vehicle Name:</strong> <?php echo $car_name; ?></p>
            <p><strong>Vehicle Number:</strong> <?php echo $car_nameplate; ?></p>
            <?php if($charge_type == "days"){ ?>
                <p><strong>Fare:</strong> Rs. <?php echo $fare; ?>/day</p>
            <?php } else { ?>
                <p><strong>Fare:</strong> Rs. <?php echo $fare; ?>/km</p>
            <?php } ?>
        </div>
        ...
        <div class="booking-info">
            ...
            <p><strong>Return Date:</strong> <?php echo $rent_end_date; ?></p>
        </div>
